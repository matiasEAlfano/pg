			...
			<div class="row">
                ...
                <div class="col s6 m7 l7">
                    <div class="row hide-on-med-and-down">
						<div class="col col-slider s12 m12 l12">
							<div class="slider">
								<ul class="slides">
								  <li>
									<img src="img/bisonte.jpg"> <!-- random image -->
									<div class="caption left-align">
									  <h3>El Bisonte</h3>
									  <h5 class="light grey-text text-lighten-5">Al encontrarse rodeado de nieve, utiliza su voluminosa cabeza para separarla y encontrar el pasto o abrirse paso.</h5>
									</div>
								  </li>
								  <li>
									<img src="img/coyote.jpg"> <!-- random image -->
									<div class="caption right-align">
									  <h3>El Coyote</h3>
									  <h5 class="light grey-text text-lighten-5">Han ampliado su hábitat desde la conquista de América por los europeos</h5>
									</div>
								  </li>
								  <li>
									<img src="img/lavanda.jpg"> <!-- random image -->
									<div class="caption left-align">
									  <h3>La lavanda</h3>
									  <h5 class="light grey-text text-lighten-5">Esta planta es endémica de la región mediterránea occidental y se reproduce por semillas.</h5>
									</div>
								  </li>                        
								</ul>
							</div> <!--fin slider-->
					...
					<div id="tarjetas" class="row">
						<div class="col s12 m6 l6 columna-1">
							<div id="novedades" class="row row-cards">
								<div class="col s12 row-cards-titulo">
								...
								<div class="col s12">
									<div class="card">
										...
										<div class="card-content">
										  <span class="card-title activator grey-text text-darken-4">Caza furtiva</span>
								...
								<div class="col s12">
									<div class="card">
										...
										<div class="card-content">
										  <span class="card-title activator grey-text text-darken-4">Cambio climático en el ártico.</span>
										  <p><a href="#">Entrar</a><i class="material-icons right">more_vert</i></p>
										</div>
										<div class="card-reveal">
										  <span class="card-title grey-text text-darken-4">Zoo Virtual<i class="material-icons right">close</i></span>
								...
								<div class="col s12">
									<div class="card">
										...
										<div class="card-content">
										  <span class="card-title activator grey-text text-darken-4">A los animales también les duelen los dientes.</span>
										  <p><a href="#">Entrar</a><i class="material-icons right">more_vert</i></p>
										</div>
										<div class="card-reveal">
										  <span class="card-title grey-text text-darken-4">Zoo Virtual<i class="material-icons right">close</i></span>
						...
						<div class="col s12 m6 l6 columna-2">
